...
import com.app_dev.trelloclone.activites.TaskListActivity
...
open class TaskListItemAdapter (
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(holder is MyViewHolder){
            ...
            holder.itemView.ib_close_card_namr.setOnClickListener {
            ...
            val helper=ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
                ...
                override fun clearView(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder) {
                    ...
                    {
                        (context as TaskListActivity).updateCardsIntTaskList(position,list[position].cards)
